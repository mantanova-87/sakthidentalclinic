                ...
                <div className="grid items-center gap-5 py-5 lg:grid-cols-1">
                    <div className="grid grid-cols-1 lg:grid-cols-2 border  rounded-2xl">
                        <div className="lg:col-span-2 ml-6 rounded-xl">
                            ...
                            <p className="mt-2 ml-2 mr-2 mb-2 font-bold text-2xl lg:3xl">
                                Your Trusted Partner in Dental Care
                            </p>
                        </div>
                        <div className="mt-4 grid  ml-6  indent-8 mr-4  text-justify text-lg lg:xl">
                            ...
                            commitment to patient wellbeing.<br />In 2004, Dr. Anupriya established Sakthi Dental
                            Clinic in Hosur with a clear vision to make high-quality dental care accessible to all.
                            Her dedication extends beyond private practice, reflected in her long-standing service
                            with the Primary Health Center at Chandara Hospital, where she has been a trusted dental
                        ...
                        <div className="lg:col-span-2  ml-6 mb-2 indent-8 mr-4  text-justify text-lg lg:xl">
                            ...
                            needs.<br /><p>Whether you're looking for preventive care, cosmetic enhancements, or restorative
                                solutions, Dr. Anupriya and her team are committed to delivering excellence at every
                                step. Because here, your smile isn’t just treated  it’s celebrated.</p>
                        </div>
                    </div>
