...
export function FAQ() {
  const item = [
    ...
    {
      question:
        "2. Does teeth scaling cause enamel damage, sensitivity, or gaps between teeth?",
      answer:
    ...
    {
      question:
        "5. Is placing a cap or crown necessary after root canal treatment (RCT)?",
      answer:
      ...
      <Container>
        ...
        <div className="mt-6 grid gap-4">
          {item.map((item) => (
            ...
            >
              <h3 className="font-semibold font-heading text-heading mb-2">
                {item.question}
              </h3>
